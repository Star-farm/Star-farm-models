"""Convert rapport_peragent_vs_global.md -> .pdf (fig4_*.png embedded)."""
import os
import re
...
MD = os.path.join(HERE, "rapport_peragent_vs_global.md")
PDF = os.path.join(HERE, "rapport_peragent_vs_global.pdf")
