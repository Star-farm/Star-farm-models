"""Convert rapport_objectifs.md -> .pdf (objectives comparison curves embedded)."""
import os
import re
...
MD = os.path.join(HERE, "rapport_objectifs.md")
PDF = os.path.join(HERE, "rapport_objectifs.pdf")
