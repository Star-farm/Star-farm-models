"""Convert rapport_marl_box6.md -> rapport_marl_box6.pdf (figures embedded)."""
import os
import re
...
MD = os.path.join(HERE, "rapport_marl_box6.md")
PDF = os.path.join(HERE, "rapport_marl_box6.pdf")
