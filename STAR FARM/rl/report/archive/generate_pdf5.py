"""Convert rapport_eval_par_fermier.md -> .pdf (per-farmer curves embedded)."""
import os
import re
...
MD = os.path.join(HERE, "rapport_eval_par_fermier.md")
PDF = os.path.join(HERE, "rapport_eval_par_fermier.pdf")
